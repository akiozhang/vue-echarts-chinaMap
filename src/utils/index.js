...
import $ from 'jquery'
var zhongguo = require('echarts/map/js/china');
var xianggang = require('echarts/map/js/province/xianggang');
var aomen = require('echarts/map/js/province/aomen');
var xndq = require('./map/xndq.json');
var dndq = require('./map/dndq.json');
var bfdq =require('./map/bfdq.json');
var dbdq = require('./map/dbdq.json');
var hbdq = require('./map/hbdq.json');
var hddq = require('./map/hddq.json');
var hzdq = require('./map/hzdq.json');
var zxdq = require('./map/zxdq.json');
var hndq = require('./map/hndq.json');
var jsdq = require('./map/jsdq.json');
var allCtyData = [
    {
        name: '南京市',
        value: 1
...
export function makeChart(id, opt) {
    // 实例
    ...
    if (opt) opt = _.cloneDeep(defaultOpt, opt);
